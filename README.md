...
This bot is originally based on birdtradebot bot (https://github.com/nellore/vickitrix), but heavily modified to become more robust and to support new rules.
